...
const features = [
  {
    ...
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <circle cx="12" cy="12" r="9" stroke="#14397A" strokeWidth="1.8"/>
        <path d="M9 12l2 2 4-4" stroke="#14397A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <rect x="3" y="3" width="8" height="8" rx="2" stroke="#14397A" strokeWidth="1.8"/>
        <rect x="13" y="3" width="8" height="8" rx="2" stroke="#14397A" strokeWidth="1.8"/>
        <rect x="3" y="13" width="8" height="8" rx="2" stroke="#14397A" strokeWidth="1.8"/>
        <path d="M13 17h8M17 13v8" stroke="#14397A" strokeWidth="1.8" strokeLinecap="round"/>
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path d="M12 2l3 6 7 1-5 5 1 7-6-3-6 3 1-7-5-5 7-1z" stroke="#14397A" strokeWidth="1.8" strokeLinejoin="round" fill="none"/>
      </svg>
    ),
